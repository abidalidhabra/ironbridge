...
<div class="right_paddingboxpart">
    ...
    <div class="srfrdbox">
        ...
        <div class="custredbtn">
            <h4>Status : </h4>
            <div class="selection">
                <input id="all" value="all" name="status" checked type="radio">
                <label for="all">ALL</label>
            </div>
            <div class="selection">
                <input id="gold" value="gold" name="status" type="radio">
                <label for="gold">GOLD</label>
            </div>
            <div class="selection">
                <input id="skeleton" value="skeleton" name="status" type="radio">

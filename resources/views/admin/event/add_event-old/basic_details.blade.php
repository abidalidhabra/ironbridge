            ...
            <div class="allbasicdirmain">                
                <div class="allbasicdirbox">                
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="event_start_date" class="form-control" placeholder="Enter the start date" value="@if(isset($event->starts_at)){{ $event->starts_at }} @endif"  data-date-format="DD-MM-YYYY hh:mm A" id="startdate">
                    </div>
                    <div class="form-group col-md-3">
                        <label class="form-label">End Date</label>
                        <input type="text" name="event_end_date" class="form-control" placeholder="Enter the date" value="@if(isset($event->ends_at)){{ $event->ends_at }}@endif"  data-date-format="DD-MM-YYYY hh:mm A" id="enddate">
                    </div>
                    <div class="form-group col-md-3">

                                ...
                                @forelse($day['games'] as $index => $miniGame)
                                    <div class="game_box">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="row[{{$key}}][{{$index}}]" class="form-control" placeholder="Enter the row" value="{{ $miniGame['variation_data']['row'] }}">
                                        </div>
                                        <input type="hidden" name="last_elem_index" value="{{ $index }}">
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Column</label>
                                            <input type="text" name="column[{{$key}}][{{$index}}]" class="form-control" placeholder="Enter the column" value="{{ $miniGame['variation_data']['column'] }}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label">Target</label>
                                            <input type="text" name="target[{{$key}}][{{$index}}]" class="form-control" placeholder="Enter the target"  value="{{ $miniGame['variation_data']['target'] }}">
                                        </div>

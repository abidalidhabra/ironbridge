<div class="left_paretboxpart">
	<div class="innercategories">
		<ul>
			...
			<li  class="@if(Route::currentRouteName() == 'admin.mapsList' || Route::currentRouteName() == 'admin.boundary_map' || Route::currentRouteName() == 'admin.starComplexityMap') {{ 'activelist' }} @endif">

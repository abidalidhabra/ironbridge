...
use App\Rules\Hunt\UseTheSkeletonKeyRule;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Exceptions\HttpResponseException;

class UseTheSkeletonKeyRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'hunt_user_details_id' => ['required', new UseTheSkeletonKeyRule($this->ownableUser()->id)]
        ];
    }
